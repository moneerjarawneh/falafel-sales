...
Route::middleware('guest')->group(function(){Route::get('/setup',[AuthController::class,'createFirstUser'])->name('setup');Route::post('/setup',[AuthController::class,'storeFirstUser'])->name('setup.store');});
